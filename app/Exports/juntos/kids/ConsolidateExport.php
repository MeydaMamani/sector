            ...
            if($a == 'TODOS'){
                ...
                $nominal = DB::table('dbo.CONSOLIDADO_NINO_PAQUETE_JUNTOS')
                            ->select('*', DB::raw("CONCAT(PATERNO_TITULAR,' ',MATERNO_TITULAR,' ', NOMBRES_TITULAR) AS FULLNAME_TITULAR"),
                                ...
                                'EH_12M AS EH_12M', 'EH_13M AS EH_13M', 'EH_14M AS EH_14M', 'EH_15M AS EH_15M', 'EH_16M AS EH_16M', 'EH_17M AS EH_17M',
                                'EH_18M AS EH_18M', 'EH_19M AS EH_19M', 'EH_20M AS EH_20M', 'EH_21M AS EH_21M', 'EH_22M AS EH_22M', 'EH_23M AS EH_23M')
                                 ->whereYear('FECHA_DE_NAC_MO', $a) ->orderBy('PROVINCIA_RES') ->orderBy('DISTRITO_RES') ->get();
            }
        }
            ...
            if($a == 'TODOS'){
                $nominal = DB::table('dbo.CONSOLIDADO_NINO_PAQUETE_JUNTOS')
                            ->select('*', DB::raw("CONCAT(PATERNO_TITULAR,' ',MATERNO_TITULAR,' ', NOMBRES_TITULAR) AS FULLNAME_TITULAR"),
                                ...
                                'EH_12M AS EH_12M', 'EH_13M AS EH_13M', 'EH_14M AS EH_14M', 'EH_15M AS EH_15M', 'EH_16M AS EH_16M', 'EH_17M AS EH_17M',
                                'EH_18M AS EH_18M', 'EH_19M AS EH_19M', 'EH_20M AS EH_20M', 'EH_21M AS EH_21M', 'EH_22M AS EH_22M', 'EH_23M AS EH_23M')
                                ->where('PROVINCIA_RES', $r) ->orderBy('PROVINCIA_RES') ->orderBy('DISTRITO_RES') ->get();
            }
            else{
                $nominal = DB::table('dbo.CONSOLIDADO_NINO_PAQUETE_JUNTOS')
                            ->select('*', DB::raw("CONCAT(PATERNO_TITULAR,' ',MATERNO_TITULAR,' ', NOMBRES_TITULAR) AS FULLNAME_TITULAR"),
                                ...
                                'EH_12M AS EH_12M', 'EH_13M AS EH_13M', 'EH_14M AS EH_14M', 'EH_15M AS EH_15M', 'EH_16M AS EH_16M', 'EH_17M AS EH_17M',
                                'EH_18M AS EH_18M', 'EH_19M AS EH_19M', 'EH_20M AS EH_20M', 'EH_21M AS EH_21M', 'EH_22M AS EH_22M', 'EH_23M AS EH_23M')
                                ->where('PROVINCIA_RES', $r) ->whereYear('FECHA_DE_NAC_MO', $a) ->orderBy('PROVINCIA_RES') ->orderBy('DISTRITO_RES') ->get();
            }
        }
        else{
            if($a == 'TODOS'){
                $nominal = DB::table('dbo.CONSOLIDADO_NINO_PAQUETE_JUNTOS')
                            ->select('*', DB::raw("CONCAT(PATERNO_TITULAR,' ',MATERNO_TITULAR,' ', NOMBRES_TITULAR) AS FULLNAME_TITULAR"),
                                ...
                                'EH_12M AS EH_12M', 'EH_13M AS EH_13M', 'EH_14M AS EH_14M', 'EH_15M AS EH_15M', 'EH_16M AS EH_16M', 'EH_17M AS EH_17M',
                                'EH_18M AS EH_18M', 'EH_19M AS EH_19M', 'EH_20M AS EH_20M', 'EH_21M AS EH_21M', 'EH_22M AS EH_22M', 'EH_23M AS EH_23M')
                                ->where('DISTRITO_RES', $d) ->orderBy('PROVINCIA_RES') ->orderBy('DISTRITO_RES') ->get();
            }
            else{
                $nominal = DB::table('dbo.CONSOLIDADO_NINO_PAQUETE_JUNTOS')
                            ->select('*', DB::raw("CONCAT(PATERNO_TITULAR,' ',MATERNO_TITULAR,' ', NOMBRES_TITULAR) AS FULLNAME_TITULAR"),
                                ...
                                'EH_12M AS EH_12M', 'EH_13M AS EH_13M', 'EH_14M AS EH_14M', 'EH_15M AS EH_15M', 'EH_16M AS EH_16M', 'EH_17M AS EH_17M',
                                'EH_18M AS EH_18M', 'EH_19M AS EH_19M', 'EH_20M AS EH_20M', 'EH_21M AS EH_21M', 'EH_22M AS EH_22M', 'EH_23M AS EH_23M')
                                ->where('DISTRITO_RES', $d) ->whereYear('FECHA_DE_NAC_MO', $a) ->orderBy('PROVINCIA_RES') ->orderBy('DISTRITO_RES') ->get();
            }
        }
