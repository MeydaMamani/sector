    ...
    <table>
        ...
        <thead>
            ...
            <tr>
                ...
                <th style="background: #FCCECA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Ubigeo Dist Familia</th>
                <th style="background: #FCCECA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Departamento Familia</th>
                <th style="background: #FCCECA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Provincia Familia</th>
                <th style="background: #FCCECA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Distrito Familia</th>
                <th style="background: #FCCECA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Ubigeo CCPP Familia</th>
                <th style="background: #FCCECA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Centro Poblado Familia</th>
                ...
                <th style="background: #FCCECA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Localidad Indigena</th>
                <th style="background: #FCCECA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Latitud</th>
                <th style="background: #FCCECA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Longitud</th>
                ...
                <th style="background: #E7FCE3; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Teléfono</th>

                <th style="background: #E7FCE3; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Dirección Familia</th>
                <th style="background: #B1D4FC; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Cod Familia</th>
        ...
        <tbody>
            ...
            @foreach($nominal as $list)
                <tr>
                    ...
                    <td>{{ $list->Ubigeo_distrital_de_la_familia }}</td>
                    <td>{{ $list->Departamento_de_la_familia }}</td>
                    <td>{{ $list->Provincia_de_la_familia }}</td>
                    <td>{{ $list->Distrito_de_la_familia }}</td>
                    <td>{{ $list->Ubigeo_CCPP_de_la_familia }}</td>
                    <td>{{ $list->Nombre_del_Centro_poblado_de_la_familia }}</td>
                    <td>{{ $list->AMBITO_INDIGENA_Amazonico_o_Andino }}</td>
                    <td>{{ $list->PUEBLO_INDIGENA }}</td>
                    <td>{{ $list->LOCALIDAD_INDIGENA }}</td>
                    <td>{{ $list->Latitud }}</td>
                    <td>{{ $list->Longitud }}</td>
                    <td>{{ $list->Código_de_cuidador_principal }}</td>
                    ...
                    <td>{{ $list->Direccion_de_la_familia }}</td>
                    <td>{{ $list->Código_de_Familia }}</td>
