...
<body>
    <table>
        <thead>
            ...
            <tr><td colspan="8"></td></tr>
            <tr>
                <td colspan="8" style="font-size: 18px; border: 3px solid #807d7d; font-weight: 500; text-align: center;">Reporte de Examenes Auxiliares - Conteo {{ $anio }}</td>
            </tr>
            <tr><td colspan="8"></td></tr>
            <tr><td colspan="8"></td></tr>
        </thead>
        ...
        <tbody>
            @foreach($nominal as $list)
                <tr>
                    ...
                    <td style="text-align: center; border: 3px solid #A6A6A6;">{{ $list->BATERIA_JUNT }}</td>
                    <td style="text-align: center; border: 3px solid #A6A6A6;">{{ round($list->AVANCE_JUNT, 1) }}%</td>
                    <td style="text-align: center; border: 3px solid #A6A6A6;">{{ $list->BATERIA_HIS }}</td>
