                                    ...
                                    <div class="card card-outline card-primary">
                                        ...
                                        <div class="card-body p-3">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-2 filter_fed">
                                                        <select class="form-control" data-width="100%" v-model="anioGrafEA" @change="grafPregnantsEA">
                                                            <option value="-">Seleccione año</option>
                                                            <option value="2020">2020</option>
                                                            <option value="2021">2021</option>
                                                            <option value="2022">2022</option>
                                                    ...
                                                    <button class="btn btn-outline-primary w-100 btn-sm mb-2" data-toggle="modal" data-target="#modalEA" @click="tableResumEA">
                                                        Examenes Auxiliares
                                                    </button>
                                    ...
                                    <div class="card card-outline card-success">
                                        ...
                                        <div class="card-body p-3">
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="mb-2 filter_fed">
                                                        <select class="form-control" data-width="100%" v-model="anioGrafAP" @change="grafPregnantsAP">
                                                            <option value="-">Seleccione año</option>
                                                            <option value="2020">2020</option>
                                                            <option value="2021">2021</option>
                                                            <option value="2022">2022</option>
                                                    ...
                                                    <button class="btn btn-outline-success w-100 btn-sm mb-2" data-toggle="modal" data-target="#modalAP" @click="tableResumAP">
                                                        Atención Prenatal
                                                    </button>
                                                </div>
                                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="mb-2 col-md-3">
                                    <select class="form-control" data-width="100%" v-model="anioTableEA" @change="tableResumEA">
                                        <option value="2020">2020</option>
                                        <option value="2021">2021</option>
                                        <option value="2022">2022</option>
                                        <option value="TODOS">TODOS</option>
                                ...
                                <h5 class="card-header text-white text-center p-1 font-13" style="background: #198754;">Examenes Auxiliares</h5>
                                    <div class="card-body p-2">
                                        <form method="POST" id="formEA" @submit.prevent="PrintEA">
                                            ...
                                            <div class="mb-2 form-group">
                                                <select class="form-control select2 show-tick" data-width="100%" name="anioEA" v-select2 required>
                                                    <option value="-">Seleccione Año</option>
                                                    <option value="2020">2020</option>
                                                    <option value="2021">2021</option>
                                                    <option value="2022">2022</option>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-9">
                                <div class="mb-2 col-md-3">
                                    <select class="form-control" data-width="100%" v-model="anioTableAP" @change="tableResumAP">
                                        <option value="2020">2020</option>
                                        <option value="2021">2021</option>
                                        <option value="2022">2022</option>
                                        <option value="TODOS">TODOS</option>
                                ...
                                <h5 class="card-header text-white text-center p-1 font-13" style="background: #198754;">APN</h5>
                                    <div class="card-body p-2">
                                        <form method="POST" id="formAP" @submit.prevent="PrintAP">
                                            ...
                                            <div class="mb-2 form-group">
                                                <select class="form-control select2 show-tick" data-width="100%" name="anioAP" v-select2 required>
                                                    <option value="-">Seleccione Año</option>
                                                    <option value="2020">2020</option>
                                                    <option value="2021">2021</option>
                                                    <option value="2022">2022</option>
