...
<body>
    <table>
        <thead>
            ...
            <tr><td colspan="8"></td></tr>
            <tr>
                <td colspan="8" style="font-size: 18px; border: 3px solid #807d7d; font-weight: 500; text-align: center;">Reporte de Suplementación de Niños de 1 a 2 Años - Conteo {{ $anio }}</td>
            </tr>
            <tr><td colspan="8"></td></tr>
            <tr><td colspan="8"></td></tr>
        </thead>
        ...
        <tbody>
            @foreach($nominal as $list)
                <tr>
                    ...
                    <td style="text-align: center; border: 3px solid #A6A6A6;">{{ $list->NUM_JUNT }}</td>
