...
<body>
    <table>
        <thead>
            ...
            <tr><td colspan="8"></td></tr>
            <tr>
                <td colspan="8" style="font-size: 18px; border: 3px solid #807d7d; font-weight: 500; text-align: center;">Reporte Paquete Niños - Conteo {{ $anio }}</td>
            </tr>
            <tr><td colspan="8"></td></tr>
            <tr><td colspan="8"></td></tr>
        </thead>
        <thead>
            <tr>
                ...
                <th style="background: #b5d3fa; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Avance His</th>
                <th style="background: #f6c3cf; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Num Juntos</th>
                <th style="background: #f6c3cf; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Avance Juntos</th>
            </tr>
        </thead>
        <tbody>
            @foreach($nominal as $list)
                <tr>
                    ...
                    <td style="text-align: center; border: 3px solid #A6A6A6;">{{ $list->NUM_HIS }}</td>
                    <td style="text-align: center; border: 3px solid #A6A6A6;">{{
                        round(($list->NUM_HIS/$list->DENOMINADOR)*100, 1);
                    }}%</td>
                    <td style="text-align: center; border: 3px solid #A6A6A6;">{{ $list->NUM_JUNTOS}}</td>
                    <td style="text-align: center; border: 3px solid #A6A6A6;">{{
                        round(($list->NUM_JUNTOS/$list->DENOMINADOR)*100, 1);
                    }}%</td>
                </tr>
            @endforeach
        </tbody>
