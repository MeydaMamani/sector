...
<body>
    <table>
        <thead>
            ...
            <tr><td colspan="12"></td></tr>
            <tr>
                <td colspan="12" style="font-size: 17px; border: 3px solid #807d7d; font-weight: 500; text-align: center;">Reporte Nominal de Suplementación en Niños de 6 a 11 Meses {{ $anio }}</td>
            </tr>
            <tr><td colspan="12"></td></tr>
            <tr><td colspan="12"></td></tr>
        </thead>
