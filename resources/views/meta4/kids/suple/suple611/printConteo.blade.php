...
<body>
    <table>
        <thead>
            ...
            <tr><td colspan="6"></td></tr>
            <tr>
                <td colspan="6" style="font-size: 16px; border: 3px solid #807d7d; font-weight: 500; text-align: center;">Reporte de Suplementación Niños de 6 a 11 Meses - Conteo {{ $anio }}</td>
            </tr>
            <tr><td colspan="6"></td></tr>
            <tr><td colspan="6"></td></tr>
        </thead>
