...
<body>
    <table>
        <thead>
            ...
            <tr><td colspan="6"></td></tr>
            <tr>
                <td colspan="6" style="font-size: 16px; border: 3px solid #807d7d; font-weight: 500; text-align: center;">Reporte de Tamizaje de niños de 6 Meses - Conteo {{ $anio }}</td>
            </tr>
            <tr><td colspan="6"></td></tr>
            <tr><td colspan="6"></td></tr>
        </thead>
        <thead>
            <tr>
                ...
                <th style="background: #b5d3fa; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Tmz His</th>
