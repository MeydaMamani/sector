...
<body>
    <table>
        <thead>
            ...
            <tr><td colspan="12"></td></tr>
            <tr>
                <td colspan="12" style="font-size: 17px; border: 3px solid #807d7d; font-weight: 500; text-align: center;">Reporte Nominal de Tamizaje en Niños de 18 Meses {{ $anio }}</td>
            </tr>
            <tr><td colspan="12"></td></tr>
            <tr><td colspan="12"></td></tr>
        </thead>
        <thead>
            <tr>
                ...
                <th style="background: #B5D3FA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Dosaje_HBM_18M</th>
