...
<body>
    <table>
        <thead>
            ...
            <tr><td colspan="9"></td></tr>
            <tr>
                <td colspan="9" style="font-size: 17px; border: 3px solid #807d7d; font-weight: 500; text-align: center;">Reporte Nominal de Vacunación en Niños de 4 Meses {{ $anio }}</td>
            </tr>
            <tr><td colspan="9"></td></tr>
            <tr><td colspan="9"></td></tr>
        </thead>
        <thead>
            <tr>
                ...
                <th style="background: #B5D3FA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Neumo 4M</th>
                <th style="background: #B5D3FA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Rota 4M</th>
                <th style="background: #B5D3FA; font-weight: 500; text-align: center; border: 3px solid #A6A6A6;">Penta 4M</th>
