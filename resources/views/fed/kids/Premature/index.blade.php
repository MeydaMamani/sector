...
@section('content')
    <div class="content-wrapper" id="appPremature">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 col-sm-4 text-center p-1">
                            <button type="submit" name="exportarCSV" class="btn btn-outline-success m-1 btn-sm mb-2 font-11" @click="PrintNominal"><i class="fa fa-print"></i> Imprimir</button>
                            <button type="button" class="btn btn-outline-danger m-1 btn-sm btn_information mb-2 font-11" data-toggle="modal" data-target="#ModalInformation"><i class="fa fa-list"></i> Ficha</button>
                            <a href="{{ url('/dashboard') }}" class="btn btn-outline-secondary btn-sm m-1 mb-2 font-11"><i class="fa fa-reply"></i> Regresar</a>
                            <button class="btn btn-outline-primary m-1 btn-sm mb-2 font-11" @click="viewAll"><i class="fa fa-check"></i> Ver Todo</button>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <div id="table_resume">
                        ...
                        <div class="col-md-2 col-sm-4">
                            <div class="card" style="border-color: #337ab7;">
                                <div class="card-body p-2">
                                    <form method="POST" id="formulario" @submit.prevent="listPremature">
                                        <div class="col-md-12 mb-1 p-0">
                                            <select class="form-control select2 show-tick" style="width: 100%;" v-model="red" name="red" @change="filtersDistricts" v-select2>
                                                <option value="">Seleccione Red</option>
                                                <option v-for="format in provinces" :value="format.Provincia">[[ format.Provincia ]]</option>
                                            </select>
                                        </div>
                                        <div class="col-md-12 mb-1 p-0">
                                            <select class="form-control select2 show-tick" style="width: 100%;" v-model="distrito" name="distrito" v-select2>
                                                <option value="">Seleccione Distrito</option>
                                                <option v-for="format in districts" :value="format.Distrito">[[ format.Distrito ]]</option>
                                            </select>
                                        </div>
                                        <div class="col-md-12 mb-1 p-0">
                                            <select class="form-control select2 show-tick" style="width: 100%;" v-model="anio" name="anio" v-select2>
                                        ...
                                        <div class="col-md-12 mb-1 p-0">
                                            <select class="form-control select2 show-tick" style="width: 100%;" v-model="mes" name="mes" v-select2>
        ...
        <!-- MODAL INFORMACION-->
        <div class="modal fade" id="ModalInformation" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <script src="./js/fed/prematuro.js"></script>
@endsection
