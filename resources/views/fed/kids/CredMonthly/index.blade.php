        ...
        <section class="content">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-8">
                            <h5 class="mb-0">Cred Mensual - <span class="name_mes">[[ nameMonth ]]</span> <span class="name_anio">[[ nameYear ]]</span></h5>
                        </div>
                        <div class="col-sm-4">
                            <ol class="breadcrumb float-sm-right font-14">
                                <li class="breadcrumb-item"><a href="#">Inicio</a></li>
                                <li class="breadcrumb-item"><a href="#">Fed</a></li>
                                <li class="breadcrumb-item active">Cred Mensual</li>
                            </ol>
                        </div>
                    </div>
                </div>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 col-sm-4 text-center p-1">
                            ...
                            <button class="btn btn-outline-primary m-1 btn-sm mb-2 font-11" @click="listCredMensual"><i class="fa fa-check"></i> Ver Todo</button>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <div id="table_resume">
                                    ...
                                    <form method="post" id="formulario">
                                        ...
                                        <div class="col-md-12 p-0">
                                            <div class="d-flex justify-content-center">
                                                <button class="btn btn-primary btn-sm m-1 font-11" id="search" type="button" @click="listCredMensual"><i class="fa fa-search"></i> Buscar</button>
                                ...
                                <table id="demo-foo-addrow2" class="table table-hover table-striped" data-page-size="20" data-limit-navigation="10">
                                    <thead>
                                        <tr class="font-10 text-center" style="background: #e0eff5;">
                                            ...
                                            <th class="align-middle" id="fields_cred2">Días 1er Cntrol (PC - FN)</th>
                                            <th class="align-middle" id="fields_cred2">Días 2do Cntrol (SC - FN)</th>
                                    ...
                                    <tbody>
                                        <tr v-for="(format, key) in lists" class="font-10">
                                            ...
                                            <td class="align-middle text-center">[[ format.PRIMER_CNTRL ]]</td>
                                            <td class="align-middle text-center">[[ format.SEG_CNTRL ]]</td>
                                            <td class="align-middle text-center">[[ format.TERCER_CNTRL ]]</td>
                                            <td class="align-middle text-center">[[ format.CUARTO_CNTRL ]]</td>
                                            <td class="align-middle text-center">[[ format.DIA1 ]]</td>
                                            <td class="align-middle text-center">[[ format.DIA2 ]]</td>
                                            <td class="align-middle text-center">[[ format.CUMPLE_CTRLMES ]]</td>
                                            <td class="align-middle text-center">[[ format.PRIMER_CNTRL_MES ]]</td>
                                            <td class="align-middle text-center">[[ format.SEGUNDO_CNTRL_MES ]]</td>
                                            <td class="align-middle text-center">[[ format.TERCER_CNTRL_MES ]]</td>
                                            <td class="align-middle text-center">[[ format.CUARTO_CNTRL_MES ]]</td>
                                            <td class="align-middle text-center">[[ format.QUINTO_CNTRL_MES ]]</td>
                                            <td class="align-middle text-center">[[ format.SEXTO_CNTRL_MES ]]</td>
                                            <td class="align-middle text-center">[[ format.SEPTIMO_CNTRL_MES ]]</td>
                                            <td class="align-middle text-center">[[ format.OCTAVO_CNTRL_MES ]]</td>
                                            <td class="align-middle text-center">[[ format.NOVENO_CNTRL_MES ]]</td>
                                            <td class="align-middle text-center">[[ format.DECIMO_CNTRL_MES ]]</td>
                                            <td class="align-middle text-center">[[ format.ONCEAVO_CNTRL_MES ]]</td>
                                            <template v-if="format.CUMPLE == 'CUMPLE'">
