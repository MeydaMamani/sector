        ...
        <section class="content">
            <section class="content-header">
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-sm-8">
                            <h5 class="mb-0">Tamizaje Neonatal CG02 - <span class="name_mes">[[ nameMonth ]]</span> <span class="name_anio">[[ nameYear ]]</span></h5>
                        </div>
                        <div class="col-sm-4">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1 col-sm-4 text-center p-1">
                            ...
                            <button class="btn btn-outline-primary m-1 btn-sm mb-2 font-11" @click="listTmz"><i class="fa fa-check"></i> Ver Todo</button>
                        </div>
                        <div class="col-md-4 col-sm-4">
                            <div id="table_resume">
                            ...
                            <div class="card" style="border-color: #337ab7;">
                                <div class="card-body p-2">
                                    <form method="post" id="formulario">
                                        ...
                                        <div class="col-md-12 mb-1 p-0">
                                            <select class="form-control select2 show-tick" style="width: 100%;" v-model="anio" name="anio" id="anio" v-select2>
                                                <option value="" selected="selected">Seleccione año</option>
                                        ...
                                        <div class="col-md-12 mb-1 p-0">
                                            <select class="form-control select2 show-tick" style="width: 100%;" v-model="mes" name="mes" id="mes" v-select2>
                                        ...
                                        <div class="col-md-12 p-0">
                                            <div class="d-flex justify-content-center">
                                                <button class="btn btn-primary btn-sm m-1 font-11" id="search" type="button" @click="listTmz"><i class="fa fa-search"></i> Buscar</button>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-10 mb-1">
                            <div class="table-responsive nominalTable" id="tmz_neonatal">
            ...
            <div class="modal-dialog modal-dialog-centered modal-xl">
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <img src="./img/fichas/inf_tamizaje_neonatal.png" style="width: 100%;">
                    </div>
                </div>
            </div>
        </div>
