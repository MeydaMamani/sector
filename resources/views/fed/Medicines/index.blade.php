                                ...
                                <div class="info-box-content">
                                    ...
                                    <div class="d-flex">
                                        <div class="col-md-6 justify-content-center align-items-center d-flex">
                                            <img src="./img/user_cant.png" width="45" alt="icon cantidad total">
                                        </div>
                                        <span class="info-box-number col-md-6 text-secondary font-30">[[ total ]] <span class="fa fa-check"></span></span>
                                    </div>
                                </div>
                            </div>
                                ...
                                <table id="demo-foo-addrow2" class="table table-hover table-striped" data-page-size="20" data-limit-navigation="10">
                                    ...
                                    <tbody>
                                        <tr v-for="(format, key) in lists" class="font-10">
                                            ...
                                            <td class="align-middle text-center">[[ format.Codigo_Unico ]]</td>
                                            <td class="align-middle text-center">[[ format.Nombre_Establecimiento ]]</td>
                                            <td class="align-middle text-center">[[ format.Numero_Documento_Personal ]]</td>
                                            <td class="align-middle text-center">[[ format.PERSONAL ]]</td>
                                            <td class="align-middle text-center">[[ format.Descripcion_Profesion ]]</td>
                                        </tr>
                                    </tbody>
                                    <tfoot>
                                        <tr>
